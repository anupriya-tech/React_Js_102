...
const[user,setUser]  = useState({email:"",password:"",remember_me:false,loggedin:false,signup:false});
...
{user.signup?<div><Signupcomp/></div>:<div><h1>login App</h1>
<form>
...
<br/>
<br/>
<input type="button" value="Not a Member, SignUp" id="signup" name="signup" onClick={signuphanlder} />
